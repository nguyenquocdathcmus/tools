...
export const metadata: Metadata = {
  ...
  title: {
    default: "MyTools Formatter Hub | JSON, XML, HTML, YAML, JS, TS, Java, C#",
    template: "%s | MyTools Formatter Hub",
  },
  description:
  ...
  openGraph: {
    title: "MyTools Formatter Hub",
    description:
      "One page to format JSON, XML, HTML, YAML, JS, TS, Java, C#, GraphQL, Markdown, MDX, PHP and more.",
    url: "/",
    images: [
      {
        url: "/og?name=MyTools%20Formatter%20Hub",
        width: 1200,
        height: 630,
        alt: "MyTools Formatter Hub",
      },
    ],
    siteName: "MyTools Formatter Hub",
    locale: "vi_VN",
    type: "website",
  },
  twitter: {
    ...
    images: ["/og?name=MyTools%20Formatter%20Hub"],
  },
  robots: {
    index: true,
    follow: true,
